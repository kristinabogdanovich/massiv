let question_arr = ["Какая река самая полноводная?","Что такое Арктика?","Самый внешний слой атмосферы называется?","Море без берегов","Условная линия, проведенная от одного полюса Земли к другому, называется"]
let a1_arr = ["Нил","Континент","Экзосфера","Аравийское","Параллель"]
let a2_arr = ["Миссисипи","Географический район","Ионосфера","Саргассово","Биссектриса"]
let a3_arr = ["Амазонка","Ледник","Гидросфера","Карибское","Тропик"]
let a4_arr = ["Конго","Остров","Литосфера","Средиземное","Меридиан"]
let answer_arr = ["Амазонка","Географический район","Экзосфера","Саргассово","Меридиан"]
let n_right_answer_arr = [3,2,1,2,4]
